...
progressBar:true},resizeMax:null,auto:true,debug:true,dragDrop:true,allowedTypes:null,dropZone:null,dropZoneText:"Drop files here...",fileInput:null,preview:null,dropZoneTextSize:"20px",dzDragOverColor:"#99CCFF",sizeLimit:0,method:"post",action:"upload.php",onComplete:function(response,status,event){},onSuccess:function(response,status,event){},onError:function(response,status,event){},onProgress:function(progressBar,percent,event){},beforeSend:function(data,xhr){}};self.version="0.1.0";self.options=
